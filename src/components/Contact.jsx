...
const Contact = () => {
    ...
    <div className="bg-blue-950 w-screen h-screen">
        ...
        <div className="mt-10 w-full flex flex-col justify-center items-center">
                ...
                <form action="https://formsubmit.co/dde486e9072e97fb65b8dcd3ae9ab3f2" method="post" className="text-black flex flex-col space-y-3 w-3/4 sm:w-1/2" enctype="multipart/form-data" onSubmit={handleSubmit}>
