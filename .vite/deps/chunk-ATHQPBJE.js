...
var LinearProgress = React30.forwardRef(function LinearProgress2(inProps, ref) {
  ...
  return (0, import_jsx_runtime14.jsxs)(LinearProgressRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    role: "progressbar"
  }, rootProps, {
...
true ? LinearProgress.propTypes = {
   ...
   * @default 'primary'
   */
  color: import_prop_types19.default.oneOfType([import_prop_types19.default.oneOf(["inherit", "primary", "secondary"]), import_prop_types19.default.string]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * Value between 0 and 100.
   */
  valueBuffer: import_prop_types19.default.number,
  /**
   * The variant to use.
   * Use indeterminate or query when there is no progress value.
   * @default 'indeterminate'
   */
  variant: import_prop_types19.default.oneOf(["buffer", "determinate", "indeterminate", "query"])
} : void 0;
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ATHQPBJE.js.map
